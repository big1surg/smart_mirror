...
class Weather(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.temperatureLbl = Label(self.degreeFrm, font=('Helvetica', 48), fg="white", bg="black") #font 94
...
class FullscreenWindow:
    ...
    def __init__(self):
        ...
        self.clock.pack(side=RIGHT, anchor=S, padx=50, pady=50)
        # weather
        self.weather = Weather(self.topFrame)
        self.weather.pack(side=LEFT, anchor=N, padx=50, pady=50)
        #compliment
        self.compliment = module_compliments.Compliments(self.topFrame)
        self.compliment.pack(side=RIGHT, anchor = N, padx = 50, pady=50)
        # news
        #self.news = module_news.News(self.bottomFrame)
